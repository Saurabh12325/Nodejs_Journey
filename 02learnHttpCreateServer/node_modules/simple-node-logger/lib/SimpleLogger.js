...
const Logger = require('simple-node-logger/lib/Logger');
const ConsoleAppender = require('simple-node-logger/lib/ConsoleAppender');
const FileAppender = require('simple-node-logger/lib/FileAppender');
const RollingFileAppender = require('simple-node-logger/lib/RollingFileAppender');
